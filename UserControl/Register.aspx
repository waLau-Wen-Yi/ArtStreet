...
<body>
    <form id="form1" runat="server">
        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" CancelDestinationPageUrl="~/UserControl/Login.aspx" ContinueDestinationPageUrl="~/UserControl/Login.aspx" DisplayCancelButton="True" FinishDestinationPageUrl="~/Home.aspx" BackColor="#FFFBD6" BorderColor="#FFDFAD" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em">
